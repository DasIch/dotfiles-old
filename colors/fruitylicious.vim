...
" Window Elements
hi StatusLine   guifg=#ffffff ctermfg=231 guibg=#333333 ctermbg=236 gui=bold term=bold
...
hi MatchParen   guifg=#b1b711 ctermfg=142 guibg=NONE                gui=bold term=bold

" Specials
hi Todo    guifg=#e50808 ctermfg=160 guibg=#520000 ctermbg=52 gui=bold term=bold
...
" Ruby Highlighting
hi rubySharpBang              guifg=#00d2ff ctermfg=81  guibg=#0a1323 ctermbg=233 gui=bold,italic term=bold,italic
...
hi cError   guifg=#ff0007 ctermfg=196 guibg=#200000 ctermbg=232 gui=bold term=bold
